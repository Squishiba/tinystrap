...
Steps:
- [x] Write failing test `packages/policy/test/shell.test.ts`:
...
- [x] Run `pnpm test -- shell`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/shell.ts`:
...
- [x] Add `export * from "./shell.js";` to `index.ts`. Run tests. Expected: PASS (5 tests). If the `echo $HOME/x` case parses instead of failing, the `t.includes("$")` check placement is wrong — fix before committing.
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/effects.test.ts`:
...
- [x] Run `pnpm test -- effects`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/effects.ts`:
...
- [x] Add `export * from "./effects.js";` to `index.ts`. Run tests. Expected: PASS (4 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/python.test.ts`:
...
- [x] Run `pnpm test -- python`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/python.ts`:
...
- [x] Add `export * from "./python.js";` to `index.ts`. Run tests. Expected: PASS (4 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/provenance.test.ts`:
...
- [x] Run `pnpm test -- provenance`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/provenance.ts`:
...
- [x] Add `export * from "./provenance.js";` to `index.ts`. Run tests. Expected: PASS (3 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/evasion.test.ts`:
...
- [x] Run `pnpm test -- evasion`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/evasion.ts`:
...
- [x] Add `export * from "./evasion.js";` to `index.ts`. Run tests. Expected: PASS (2 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/audit.test.ts`:
...
- [x] Run `pnpm test -- audit`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/audit.ts`:
...
- [x] Add `export * from "./audit.js";` to `index.ts`. Run tests. Expected: PASS (1 test).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/policy/test/engine.test.ts`:
...
- [x] Run `pnpm test -- engine`. Expected: FAIL — not exported.
- [x] Implement `packages/policy/src/engine.ts`:
...
- [x] Add `export * from "./engine.js";` to `index.ts`. Run `pnpm test -- engine`. Expected: PASS (10 tests). Then `pnpm test` — full policy suite green.
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/discovery/test/stub.test.ts`:
...
- [x] Run `pnpm test -- stub`. Expected: FAIL — not exported.
- [x] Implement `packages/discovery/src/index.ts`:
...
- [x] Run tests. Expected: PASS (1 test).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/config.test.ts`:
...
- [x] Run `pnpm test -- config`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/config.ts`:
...
- [x] Add `export * from "./config.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (4 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/doctor.test.ts`:
...
- [x] Run `pnpm test -- doctor`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/doctor.ts`:
...
- [x] Add `export * from "./doctor.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (2 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/taskstore.test.ts`:
...
- [x] Run `pnpm test -- taskstore`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/taskstore.ts`:
...
- [x] Add `export * from "./taskstore.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (2 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/secrets.test.ts`:
...
- [x] Run `pnpm test -- secrets`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/secrets.ts`:
...
- [x] Add `export * from "./secrets.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (2 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/snapshot-git.test.ts` (uses real `git` — it is available in Git Bash on the target machine):
...
- [x] Run `pnpm test -- snapshot-git`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/git.ts`:
...
- [x] Implement `packages/core/src/snapshot-git.ts`:
...
- [x] Extend the test file with the allowlist case (add to the same `describe`; add `mkdirSync` to the test's `node:fs` import):
...
- [x] Add `export * from "./git.js"; export * from "./snapshot-git.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (3 tests).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/snapshot-manifest.test.ts`:
...
- [x] Run `pnpm test -- snapshot-manifest`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/snapshot-manifest.ts`:
...
- [x] Add `export * from "./snapshot-manifest.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (1 test).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/patch.test.ts`:
...
- [x] Run `pnpm test -- patch`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/patch.ts`:
...
- [x] Add `export * from "./patch.js";` to `packages/core/src/index.ts`. Run tests. Expected: PASS (1 test).
- [x] Commit:
...
Steps:
- [x] Write failing test `packages/core/test/pythonast.test.ts`:
...
- [x] Write failing test `apps/cli/test/cli.test.ts`:
...
- [x] Run `pnpm test -- pythonast cli`. Expected: FAIL — not exported.
- [x] Implement `packages/core/src/pythonast.ts`:
...
- [x] Implement `apps/cli/src/main.ts`:
...
- [x] Add `export * from "./pythonast.js";` to `packages/core/src/index.ts`; add `"bin": { "tinystrap": "./src/main.ts" }` to `apps/cli/package.json` (run via `node --import tsx` later; for now tests call `runCli` directly).
- [x] Run `pnpm test`. Expected: ALL tests PASS across all packages.
- [x] Commit:
